...
/*   Updated: 2024/02/02 18:07:22 by bde-souz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	intro_0(void)
{
	...
	usleep(2000000);
	ft_printf("- Dallas: Remember: Stay low, stay dark, avoid guards and gunfire.\n");
	usleep(3000000);
...
void	intro_2(void)
{
	...
	usleep(3000000);
	ft_printf("	So all we have to do is hit the local FBI office to get our loot\n\n");
	usleep(3000000);
